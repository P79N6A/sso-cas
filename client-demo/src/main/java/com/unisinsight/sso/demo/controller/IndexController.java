...
public class IndexController {
    ...
    public String loginOut2(HttpSession session){
        ...
        return "http://localhost:8080/cas/logout?service=http://localhost:8081/client";
    }
    ...
    public String logout(HttpSession session){
        session.invalidate();
        return "redirect:http://localhost:8080/cas/logout?service=http://localhost:8081/client";
    }
