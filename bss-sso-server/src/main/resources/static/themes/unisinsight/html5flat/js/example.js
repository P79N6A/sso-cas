function animation(){
  ...
  var MESH = {
    ...
    yRange: 0.1,
    zRange: 1.0,
    ambient: config.ambientColor || '#000000',
    diffuse: '#ffffff',
    speed: 0.002
  };

  //------------------------------
  // Light Properties  -------三角形方块
  //------------------------------
  var LIGHT = {
    count: 2,
    xyScalar: 1,
  ...
  var container = document.getElementById('container_plugin');
  var controls = document.getElementById('controls_plugin');
  var output = document.getElementById('output_plugin');
  var ui = document.getElementById('ui_plugin');
